...
@section('content')
    ...
    <div class="float-right ">
        <a href="{{ route('medicines.create') }}" class="btn btn-sm btn-primary mb-2"><i class="fas fa-plus"></i> Add
            Medicine</a> <br>
    </div>
    <div class="col-12 mt-5">
        <div class="mt-5">
            <div class="container-fluid">
                <table id="table" class="table table-bordered table-responsive text-center">
                    <thead class="table">
                        <tr>
